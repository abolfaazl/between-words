...
<article <?php post_class('single-entry'); ?>>
    ...
    <div class="single-featured">
        <div class="post-image single-featured-image">
            <?php
            if (has_post_thumbnail()) {
                between_words_render_card_image(get_the_ID(), 'between-words-hero', ['context' => 'hero']);
            } else {
                between_words_the_placeholder(get_the_ID());
            }
            ?>
        </div>
    </div>
